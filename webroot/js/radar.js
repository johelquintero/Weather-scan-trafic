...
var customMap = false;
//traffic map
/*function trafficMapOn() {
	trafmap = new maplibregl.Map({
		container: 'overviewmap',
		style:
		  'https://api.tomtom.com/style/2/custom/style/dG9tdG9tQEBAQW1IV1hMWktoeTllNUJYUjs0MTk2MTUxNy1hYjRiLTQ2ZDEtODZkZC1kMzNhYmJmMDFkZjg=' + traf_key, // stylesheet location
		center: [maincitycoords.lon, maincitycoords.lat], // starting position [lng, lat]
		zoom: 9, // starting zoom
	  });
	  trafmap.on('load', () => {
	console.log("Loaded Traffic Map")
	  });
}*/
